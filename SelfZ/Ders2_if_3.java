...
public class Ders2_if_3 {
    public static void main(String[] args) {
        ...
        if (kazanc<=500) {
            ...
            System.out.println("Vergi hesaplanıyor...");

            if (kazanc<=1000) { //kazanc>500 biliyorum ama 1000'den küçük mü?
            ...
            System.out.println("Vergi hesaplandı...");
        }
